...
export const DreamPOSMenu: MenuItem[] = [
  {
    label: "Main",
    submenuOpen: true,
    showSubRoute: false,
  ...
  },
  {
    ...
    submenuItems: [
      { label: "Products", link: "/product-list", icon: Package, showSubRoute: false, submenu: false },
      { label: "Create Product", link: "/add-product", icon: PlusSquare, showSubRoute: false, submenu: false },
      { label: "Expired Products", link: "/expired-products", icon: Box, showSubRoute: false, submenu: false },
      { label: "Low Stocks", link: "/low-stocks", icon: TrendingDown, showSubRoute: false, submenu: false },
      { label: "Category", link: "/category-list", icon: Code, showSubRoute: false, submenu: false },
      { label: "Sub Category", link: "/sub-categories", icon: Radio, showSubRoute: false, submenu: false },
      { label: "Brands", link: "/brand-list", icon: Tag, showSubRoute: false, submenu: false },
      { label: "Units", link: "/units", icon: Radio, showSubRoute: false, submenu: false },
      { label: "Variant Attributes", link: "/variant-attributes", icon: Layers, showSubRoute: false, submenu: false },
      { label: "Warranties", link: "/warranty", icon: Bookmark, showSubRoute: false, submenu: false },
      { label: "Print Barcode", link: "/barcode", icon: AlignJustify, showSubRoute: false, submenu: false },
      { label: "Print QR Code", link: "/qrcode", icon: Maximize, showSubRoute: false, submenu: false }
    ]
  },
  {
    label: "Stock",
    ...
    showSubRoute: false,
    submenuItems: [
      { label: "Manage Stock", link: "/manage-stocks", icon: Package, showSubRoute: false, submenu: false },
      { label: "Stock Adjustment", link: "/stock-adjustment", icon: Clipboard, showSubRoute: false, submenu: false },
      { label: "Stock Transfer", link: "/stock-transfer", icon: Truck, showSubRoute: false, submenu: false }
    ]
  },
  {
    label: "Sales",
    ...
    showSubRoute: false,
    submenuItems: [
      { label: "Sales", link: "/sales-list", icon: ShoppingCart, showSubRoute: false, submenu: false },
      { label: "Invoices", link: "/invoice-report", icon: FileText, showSubRoute: false, submenu: false },
      { label: "Sales Return", link: "/sales-returns", icon: Copy, showSubRoute: false, submenu: false },
      { label: "Quotation", link: "/quotation-list", icon: Save, showSubRoute: false, submenu: false },
      { label: "POS", link: "/pos", icon: HardDrive, showSubRoute: false, submenu: false }
    ]
  },
  {
    label: "Promo",
    ...
    showSubRoute: false,
    submenuItems: [
      { label: "Coupons", link: "/coupons", icon: ShoppingCart, showSubRoute: false, submenu: false }
    ]
  },
  {
    label: "Purchases",
    ...
    showSubRoute: false,
    submenuItems: [
      { label: "Purchases", link: "/purchase-list", icon: ShoppingBag, showSubRoute: false, submenu: false },
      { label: "Purchase Order", link: "/purchase-order-report", icon: FileMinus, showSubRoute: false, submenu: false },
      { label: "Purchase Return", link: "/purchase-returns", icon: RefreshCw, showSubRoute: false, submenu: false }
    ]
  },
  {
  ...
  },
  {
    ...
    submenuHdr: "People",
    submenuItems: [
      { label: "Customers", link: "/customers", icon: User, showSubRoute: false, submenu: false },
      { label: "Suppliers", link: "/suppliers", icon: Users, showSubRoute: false, submenu: false },
      { label: "Stores", link: "/store-list", icon: Home, showSubRoute: false, submenu: false },
      { label: "Warehouses", link: "/warehouse", icon: Archive, showSubRoute: false, submenu: false }
    ]
  },
  {
    label: "HRM",
    ...
    submenuHdr: "HRM",
    submenuItems: [
      { label: "Employees", link: "/employees-grid", icon: Users, showSubRoute: false },
      { label: "Departments", link: "/department-grid", icon: User, showSubRoute: false },
      { label: "Designations", link: "/designation", icon: UserCheck, showSubRoute: false },
      { label: "Shifts", link: "/shift", icon: Shuffle, showSubRoute: false },
      {
        label: "Attendance",
        link: "#",
        icon: Clock,
      ...
      { label: "Holidays", link: "/holidays", icon: CreditCard, showSubRoute: false },
      {
        label: "Payroll",
        link: "#",
        icon: DollarSign,
  ...
  },
  {
    ...
    submenuHdr: "Reports",
    submenuItems: [
      { label: "Sales Report", link: "/sales-report", icon: BarChart2, showSubRoute: false },
      { label: "Purchase Report", link: "/purchase-report", icon: PieChart, showSubRoute: false },
      { label: "Inventory Report", link: "/inventory-report", icon: Inbox, showSubRoute: false },
      { label: "Invoice Report", link: "/invoice-report", icon: File, showSubRoute: false },
      { label: "Supplier Report", link: "/supplier-report", icon: UserCheck, showSubRoute: false },
      { label: "Customer Report", link: "/customer-report", icon: User, showSubRoute: false },
      { label: "Expense Report", link: "/expense-report", icon: FileText, showSubRoute: false },
      { label: "Income Report", link: "/income-report", icon: BarChart, showSubRoute: false },
      { label: "Tax Report", link: "/tax-report", icon: Database, showSubRoute: false },
      { label: "Profit & Loss", link: "/profit-loss-report", icon: TrendingDown, showSubRoute: false }
    ]
  },
  {
    ...
    submenuItems: [
      { label: "Users", link: "/users", icon: UserCheck, showSubRoute: false },
      { label: "Roles & Permissions", link: "/roles-permissions", icon: UserCheck, showSubRoute: false },
      { label: "Delete Account Request", link: "/delete-account", icon: Lock, showSubRoute: false }
    ]
  },
  {
    label: "Pages",
    ...
    submenuHdr: "Pages",
    submenuItems: [
      { label: "Profile", link: "/profile", icon: User, showSubRoute: false },
      {
      ...
      { label: "Blank Page", link: "/blank-page", icon: File, showSubRoute: false },
      { label: "Coming Soon", link: "/coming-soon", icon: Send, showSubRoute: false },
      { label: "Under Maintenance", link: "/under-maintenance", icon: AlertTriangle, showSubRoute: false }
    ]
  },
  {
    label: "Settings",
    ...
    submenuItems: [
      ...
      { label: "Logout", link: "/signin", icon: LogOut, showSubRoute: false }
    ]
  },
  {
    label: 'UI Interface',
  ...
  },
  {
    ...
    submenuHdr: 'Help',
    submenuItems: [
      { label: 'Documentation', link: '#', icon: FileText, showSubRoute: false },
      { label: 'Changelog v2.0.3', link: '#', icon: Lock, showSubRoute: false },
      {
        label: 'Multi Level',
        showSubRoute: false,
        submenu: true,
